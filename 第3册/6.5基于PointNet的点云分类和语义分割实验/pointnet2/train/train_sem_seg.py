...
if __name__ == "__main__":
    ...
    test_loader = DataLoader(test_set,batch_size=args.batch_size,shuffle=True,pin_memory=True,num_workers=2)
    ...
    model = Pointnet(num_classes=3, input_channels=6, use_xyz=True)
    model.cuda()
