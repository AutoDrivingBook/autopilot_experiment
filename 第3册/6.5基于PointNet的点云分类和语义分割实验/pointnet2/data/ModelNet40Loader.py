...
class ModelNet40Cls(data.Dataset):
    ...
    def __init__(self, num_points, transforms=None, train=True, download=True):
        ...
        self.data_dir = '/home1/xuhui/Pointnet2_PyTorch-master/pointnet2/data/modelnet40_ply_hdf5_2048/'
        # self.data_dir = '/home1/xuhui/Pointnet2_PyTorch-master/pointnet2/data/3d-sample/'
        ...
        # if self.train:
        #     self.files = golb.glob(data_dir + 'bin_files')
        #     self.files.sort()
        if self.train:
            ...
            self.files =  _get_data_files( \
                os.path.join(data_dir, 'test_files.txt'))
