...
parser.add_argument("-num_points",type=int,default=100592,help="Number of points to train with [default: 2048]")
...
parser.add_argument("-decay_step",type=float,default=2e3,help="Learning rate decay step [default: 20]")
...
parser.add_argument("-run_name",type=str,default="sem_seg_run_1",help="Name for run in tensorboard_logger")
...
if __name__ == "__main__":
    ...
    test_loader = DataLoader(test_set,batch_size=args.batch_size,shuffle=True,pin_memory=True,num_workers=0)
    ...
    trainer = pt_utils.Trainer(
        ...
        best_name="/kitti_semantic/Pointnet2_PyTorch-master/pointnet2/train/checkpoints/poitnet2_semseg_best",
