...
if __name__ == "__main__":
    ...
    lr_lbmd = lambda it: max(args.lr_decay**(int(it * args.batch_size / args.decay_step)),
        lr_clip / args.lr)
    bn_lbmd = lambda it: max(args.bn_momentum * args.bnm_decay**(int(it * args.batch_size / args.decay_step)),
     bnm_clip)
    ...
    trainer = pt_utils.Trainer(model,model_fn,optimizer,
    ...
    trainer.train(0,start_epoch,args.epochs,train_loader,
